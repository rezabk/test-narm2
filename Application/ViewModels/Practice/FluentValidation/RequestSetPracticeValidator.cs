...
namespace Application.ViewModels.Practice.FluentValidation;

public class RequestSetPracticeValidator : AbstractValidator<RequestSetPracticeViewModel>
{
    public RequestSetPracticeValidator()
    {
        RuleFor(x => x.ClassId)
            .NotEmpty()
            .GreaterThan(0)
